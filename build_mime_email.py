...
# https://github.com/brandon-rhodes/fonp/bvlob/m/py3/chapter12/build_mime_email.py
...
# Tiny example GIF from http://www.perlmonks.org/?node id=7974
blue_dot = (b'GIF89a1010\x9000000\xff000,000010100\x02\x02\x0410;'
            .replace(b'0',b'\x00').replace(b'1', b'\x01'))

def main(args):
    message = email.messageEmailMessage(email.policy.SMTP)
...
if __name__ == '__main__':
    ...
    parser.add_argument('filename', nargs='*', help='Attachement filename')
